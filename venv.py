...
def after_install(options, home_dir):
	if sys.platform == 'win32':
		...
		bin = 'bin'
	subprocess.call([join(home_dir, bin, 'pip'), 'install', 'numpy'])
	subprocess.call([join(home_dir, bin, 'pip'), 'install', 'scikits.learn'])
	subprocess.call([join(home_dir, bin, 'pip'), 'install', 'scikits.audiolab'])
